...
const JobsNavigator = createStackNavigator({
    ...
    navigationOptions:{
         drawerIcon:drawerConfig => <Ionicons name="md-reorder" size={23} color="#650d88" />
    },
   
    defaultNavigationOptions:{
        headerStyle:{
            backgroundColor:'#650d88',
        },
...
const PostJobsNavigator = createStackNavigator({
    ...
    navigationOptions:{
        drawerIcon:drawerConfig => <Ionicons name="md-add" size={23} color="#650d88" />
   },
...
const UserJobsNavigator = createStackNavigator({
    ...
    navigationOptions:{
        drawerIcon:drawerConfig => <Ionicons name="md-list" size={23} color="#650d88" />
   },
...
const LogoutNavigator = createStackNavigator({
    ...
    navigationOptions:{
        drawerIcon:drawerConfig => <Ionicons name="md-log-out" size={23} color="#650d88" />
   },
